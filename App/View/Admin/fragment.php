...
<?php elseif($tpl=='view'):?>
	...
	<tr><td><?=lang('title')?></td><td><input type="text" name="title" id="title" class="validate input-text" validtip="required" size="50" value="<?=isset($view['title'])?$view['title']:'';?>"></td></tr>
	<tr><td><?=lang('varname')?></td><td><input type="text" name="varname" id="varname" class="validate input-text" validtip="required" size="50" value="<?=isset($view['varname'])?$view['varname']:'';?>"></td></tr>
	<tr><td><?=lang('content')?></td><td><textarea  cols="110" rows="20" class="editor" name="content" id="content"><?=isset($view['content'])?$view['content']:'';?></textarea></td></tr>
	<tr><td><?=lang('remark')?></td><td colspan="2"><textarea rows="3" cols="50" name="remark" id="remark" class="txtarea"><?=isset($view['remark'])?$view['remark']:'';?></textarea></td></tr>
