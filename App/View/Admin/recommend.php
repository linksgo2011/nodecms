...
<?php elseif($tpl=='view'):?>
	...
	<tr><td width="100"><?=lang('remark')?></td><td colspan="2"><textarea rows="3" cols="40" class="txtarea" name="remark" id="remark"><?=isset($view['remark'])?$view['remark']:'';?></textarea></td></tr>
	<tr><td width="100"><?=lang('status')?></td><td><?=lang('status1')?><input type="radio" name="status" value="1" <?php if(!isset($view['status'])||$view['status']==1){echo 'checked';} ?> /><?=lang('status0')?><input type="radio" name="status" value="0" <?php if(isset($view['status'])&&$view['status']==0){echo 'checked';} ?>  /></td></tr>
