...
<?php elseif($tpl=='view'):?>
	...
	<tr><td><?=lang('remark')?></td><td><textarea rows="3" cols="40" name="remark" id="remark" class="txtarea"><?=isset($view['remark'])?$view['remark']:'';?></textarea></td></tr>
