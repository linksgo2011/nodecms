<?php if($tpl=='list'):?>
	...
	<tr>
		...
		<th width=200 align=left><?=lang('keywords')?></th>
...
<?php elseif($tpl=='view'):?>
	...
	<tr><td width="100"><?=lang('keywords')?></td><td ><input type="text" name="title" id="title" size="40" class="validate input-text" validtip="required"  value="<?=isset($view['title'])?$view['title']:'';?>"></td></tr>
