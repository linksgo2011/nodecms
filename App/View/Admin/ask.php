<?php if($tpl=='list'):?>
	...
	<option value="title" <?php if ($search['searchtype'] == 'title'): ?>selected<?php endif; ?>><?=lang('ask_title')?></option>
	...
	<th align=left><?=lang('ask_title')?></th>
...
<?php elseif($tpl=='view'):?>
	...
	<tr>
		<td><?=lang('ask_title')?></td>
		<td colspan="4"><input type="text" name="title" id="title" size="78" style="color:<?=isset($view['color'])?$view['color']:'';?>" class="validate input-text" validtip="required"  value="<?=isset($view['title'])?$view['title']:'';?>">
	...
	<tr>
		<td><?=lang('keywords')?></td>
		<td colspan="4"><input type="text" name="keywords" id="keywords" class="input-text" size="78"  value="<?=isset($view['keywords'])?$view['keywords']:'';?>"></td></tr>
	<tr>
