<?php if($tpl=='list'):?>
	...
	<tr>
		...
		<th width=200  align=left><?=lang('url')?></th>
...
<?php elseif($tpl=='view'):?>
	...
	<tr><td width="100"><?=lang('title')?></td><td ><input type="text" name="title" id="title" class="validate input-text" size="40" validtip="required"  value="<?=isset($view['title'])?$view['title']:'';?>"></td>
