	...
	<div class="mainright">
		...
		<div class="rightmiddle">
			<div class="aboutcontent">
				<h1><?=$detail['title']?></h1>
				<div class="info_d"><?=lang('copyfrom')?>:<?=$detail['copyfrom']?> | <?=lang('hits')?>:<?=$detail['hits']?> | <?=lang('puttime')?>:<?=$detail['puttime']?></div>
				<div class="news_ctn" id="news_ctn"><?=$detail['content']?>
					<br>
					<p><?=lang('tags')?>:<?=$detail['tagsstr']?>
					</p>
				</div>
