/********************
 *System js Chinese Language Pack
 ********************/

var lang = {
		'delnotice':'Are you sure you want to delete the data?',
		'auditnotice':'Determine audit through?',
		'unnotice':'You cancelled the operation!',
		'nocolor':'No color',
		'add':'Add',
		'edit':'Edit',
		'login':'Login',
		'audit':'Audit',
		'grant':'Grant',
		'pselect':'Select the record',
		'submit':'Submit',
		'opersuccess':'The success of the operation',
		'colorpicker':'Color picker',
		'clearcolor':'Clear color',
		'nopurivew':'No Permission',
		'userorpasserror':'Login ID or password error',
		'duplicate':'Duplicate record',
		'notfound':'This page does not exist',
		'iswater':'Whether to add a watermark'
	}

/********************
 *The validation form js Chinese language package
 ********************/
lang.validform = {
		'onlyform':'Only supports form validation!',
		'required':{
			'text':'* Here the content cannot be empty',
			'checkmultiple':'* Please select at least one project',
			'select':'* Please select an item',
			'checkbox':'*  You must select this box'
		},
		'min':{
			'text':'* At least  ',
			'text1':' characters '
...
KindEditor.lang({
	...
	'image.iswater' : 'watermark',
	'image.upload' : 'Browse',
	'image.viewServer' : 'Browse',
	'multiimage.uploadDesc' : 'Allows users to upload <%=uploadLimit%> images, single image size not exceeding <%=sizeLimit%>',
	'multiimage.iswater' : 'watermark',
